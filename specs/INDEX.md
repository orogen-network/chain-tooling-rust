...
| [0009](./RFC-0009-operator-registration.md) | Operator Registration Flow | Pallet + Compliance Leads | Registration extrinsic with coldkey/hotkey, attestation, tier, stake (OROG + USD-pegged ratchet per DECISIONS.md H9), geo region, /24 IP hash, sanctions-check proof. Device-cert collision across coldkeys → both slashed 100% (red-team rule 7). |
